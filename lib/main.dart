                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: Icon(
                                widget.wishlistItems.contains(x.label.toString())
                                    ? Icons.favorite
                                    : Icons.favorite_border,
                                color: widget.wishlistItems.contains(x.label.toString())
                                    ? Colors.red
                                    : null, // Null means use the default color
                              ),
                              onPressed: () {
                                setState(() {
                                  if (widget.wishlistItems.contains(x.label.toString())) {
                                    int index = widget.wishlistItems.indexOf(x.label.toString());
                                    if (index != -1) {
